...
* *Provider by default* - Uses as the default value of the @provider@ attribute.
* *Custom field by default* - Uses as the default value of the @video@ attribute.
...
* @video=""@ - Video url or the video id (if used with the @provider@ attribute) for the video you want to embed.
