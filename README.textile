...
Plugin prefs are mainly used as default values for the oui_player @<txp:oui_player />@ attributes.
...
* @play=""@ - An url, an id (Soundcloud accepts url's only) or the custom field name containing it.
...
* @ui_highlight="ffcc33"@ - Changes the default highlight colour used in the controls (hex value without the leading #).
...
h4. Soundcloud additional player parameters
...
* @text_buy_track=""@ - Text of the _Buy_ button for a track.
* @text_buy_set=""@ - Text of the _Buy_ button for a set.
* @text_download_track=""@ -  Text of the _Download_ button for a track.
* @buying=""@ - Whether to display the _Buy_ button or not.
* @sharing="true"@ - @true@ or @false@ - Whether to enable the sharing features or not.
* @download=""@ - Whether to display the _Download_ button or not.
* @show_bpm=""@ - Whether to display the BPM or not.
* @start_track="0"@ - Specifies the time (in seconds) when the track should start playing.
* @font=""@ - Changes the font in use in the player interface.
* @enable_api="false"@ - @true@ or @false@ - Whether to enable the javascript api or not.
...
More informations on "this Soundcloud webpage":https://developers.soundcloud.com/docs/widget#parameters.
