...
* @api="false"@ - @postMessage@, @location@ or @1@ - Enables the Player API. In native mobile apps, use @api="location"@, otherwise we recommend using api=1.
...
* @related="true"@ (@endscreen-enable@) - @false@ or @true@ - Whether to enable the end screen or not.
...
* @sharing="true"@ - @true@ or @false@ - Whether to display the sharing button or not.
...
* @logo="true"@ (@ui-logo@) - @true@ or @false@ - Whether to display the Dailymotion logo or not.
* @info="true"@ (@ui-start-screen-info@) - @true@ or @false@ - Whether to show video information (title and owner) on the start screen.
