...
Most player parameters can also be set through plugin prefs; see "Dailymotion player":http://localhost:8888/test/textpattern-4.6/textpattern/index.php#prefs_group_oui_video_dailymotion, "Vimeo player":http://localhost:8888/test/textpattern-4.6/textpattern/index.php#prefs_group_oui_video_vimeo and "Youtube player":http://localhost:8888/test/textpattern-4.6/textpattern/index.php#prefs_group_oui_video_youtube prefs.
