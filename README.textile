...
* "Textpattern CMS":http://textpattern.com/ 4.5+ (4.6+ is recommended).
...
* @play=""@ - url, id or the custom_field containing the item to play.
* @provider=""@ - The provider to use if the @play@ attribute value is an id.
